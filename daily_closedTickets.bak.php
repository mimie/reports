...
<?php
  ...
  while($row = mysql_fetch_row($closedTickets)){
   ...
   if($circuitId != NULL && $prevCircuitId != $circuitId && $checkDateRange && $activated_Circuit){
...
<?php
   ...
   elseif($circuitId != NULL && $prevCircuitId == $circuitId && $checkDateRange && $activated_Circuit){?>
...
#Mail stuff
        ...
        //$to = "gary@imperium.ph,jmalonso@globetel.com.ph,karen@imperium.ph,touchpoint@imperium.ph,zbsbaraquel@globetel.com.ph"; 
