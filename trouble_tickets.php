   ...
   include 'ticket_functions.php';
    ...
    $sql = "SELECT name, xml_content_value, ci.last_version_id, ci.id\n"
     ...
     while($row = mysql_fetch_array($result_activatedTickets)){
           ...
           $result_troubleTickets = getLinkedTickets($source_key);
...
<?php
              ...
              while($row = mysql_fetch_array($result_troubleTickets)){
                 ...
                 //$checkDateRange = checkDateWithin30Days($ticketCreateTime,$acitvationDate_format);
                 ...
                 elseif($color == 2 && $closeDateTime != NULL){
                   echo "<tr>";
